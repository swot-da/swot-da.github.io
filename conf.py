...
BLOG_TITLE = "SWOT data assimilation inter-comparison"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://swot-da.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://swot-da.github.io/"
BLOG_EMAIL = "kandread@jpl.nasa.gov"
BLOG_DESCRIPTION = "Blog on SWOT data assimilation."  # (translatable)
...
# is in the manual.
COMMENT_SYSTEM_ID = "https-swot-da-github-io.disqus.com"
